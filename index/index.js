const
    ...
    build = ({
        ...
        const
            canonical = page => `<link rel="canonical" href="https://${websiteDomain}${page}">`,
            htmlElements = (() => {
                const elements = {};
            ...
            coverImageLink = `${websiteLink}/${assetsDir}/${imagesDir}/${coverImage}`,
            appIconFile = `/${assetsDir}/${imagesDir}/${app_icon}`,
            meta = {
                author,
